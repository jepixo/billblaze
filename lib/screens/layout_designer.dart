...
class _LayoutDesigner3State extends State<LayoutDesigner3>
  ...
  void initState() {
    ...
    if (key == -1) {
      lm = LayoutModel(docPropsList: [], spreadSheetList: [], id: Uuid().v4());
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        var item = _sheetItemIterator(
                                                                            spreadSheetList[currentPageIndex][i].id,
                                                                            spreadSheetList[currentPageIndex]) as TextEditorItem;
                                                                        ...
                                                                        TextEditingController
                                                                            hexController =
                                                                            TextEditingController()
                                                                              ..text = '${item.textEditorController.getSelectionStyle().attributes['color']?.value ?? '#00000000'}';
                                                                        TextEditingController
                                                                            bghexController =
                                                                            TextEditingController()
                                                                              ..text = '${(item.textEditorController.getSelectionStyle().attributes['background']?.value ?? '#00000000')}';
                                                                        TextEditingController
                                                                            fontSizeController =
                                                                            TextEditingController()
                                                                              ..text = '${double.parse(item.textEditorController.getSelectionStyle().attributes['size']?.value ?? '0')}';
                                                                        ...
                                                                        TextEditingController
                                                                            ...
                                                                            TextEditingController()
                                                                              ..text = '${double.parse(item.textEditorController.getSelectionStyle().attributes[LetterSpacingAttribute._key]?.value ?? '0')}';
                                                                        ...
                                                                        TextEditingController
                                                                            wordSpaceController =
                                                                            TextEditingController()
                                                                              ..text = '${double.parse(item.textEditorController.getSelectionStyle().attributes[WordSpacingAttribute._key]?.value ?? '0')}';
                                                                        ...
                                                                        TextEditingController
                                                                            lineSpaceController =
                                                                            TextEditingController()
                                                                              ..text = '${double.parse(item.textEditorController.getSelectionStyle().attributes[LineHeightAttribute._key]?.value ?? '0')}';
...
//contextMenu
                                                                            ...
                                                                            switch (value) {
                                                                              ...
                                                                              case 'Left':
                                                                                setState(() {
                                                                                  ...
                                                                                  spreadSheetList[currentPageIndex].insert(
                                                                                      index,
                                                                                      SheetList(id: newId, parentId: spreadSheetList[currentPageIndex].id, sheetList: [
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            setState(() {
                                                                              if (index != 0) {
                                                                                ...
                                                                                panelIndex = PanelIndex(id: panelIndex.id, panelIndex: panelIndex.panelIndex + 1);
  ...
  Widget _buildListWidget(SheetList sheetList) {
    ...
    return Container(
      width: sWidth,
      height: (120 * sheetList.length).ceilToDouble(),
      padding: EdgeInsets.all(0),
      ...
      child: ReorderableListView.builder(
        ...
        itemBuilder: (context, index) {
          print('hello hello sprdsheetBuilding: ${sheetList[index]}');
          if (sheetList[index] is TextEditorItem) {
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    ...
                    setState(() {
                      itemE = _sheetItemIterator(textEditorItem.id, sheetList);

                      if (itemE != null) {
                        index = _sheetListIterator(itemE!.parentId, sheetList)
                            .indexOf(itemE!);
                        panelIndex =
                            PanelIndex(id: itemE!.id, panelIndex: index);
                      } else {
                        panelIndex = PanelIndex(
                            id: textEditorItem.id, panelIndex: index);
                      }
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Text('id : ${textEditorItem.id}',
            ...
            return _buildListWidget(sheetList[index] as SheetList);
          }
          return Container(
            key: ValueKey(Uuid().v4()),
            color: Colors.amberAccent,
