...
class SheetItem extends HiveObject {
  ...
  SheetItem({
    ...
    this.itemDecoration = const [],
    required this.decorationId,
    this.decorationName = 'Untitled',
  });
...
List<dynamic> encodeItemDecorationList(List<dynamic> list) {
...
List<dynamic> decodeItemDecorationList(List<dynamic> list) {
