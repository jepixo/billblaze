  ...
  void performLayout(Size size) {
    ...
    super.layoutChild(
      ...
      BoxConstraints.tightFor(
          width: size.width, height: _ThumbPainter.doubleTrackWidth/3),
    );
    super.positionChild(
      track,
      Offset(0.0, (size.height  - _ThumbPainter.trackWidth+2)),
    );
...
class _ThumbPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset.zero, _ThumbPainter.width/3, paintBlack); 
  }
