...
class _WheelPainter extends CustomPainter {
  ...
  static double doubleStrokeWidth = 4;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      ...
      Paint()
        ...
        ..strokeWidth = _WheelPainter.doubleStrokeWidth/1
        ..shader = sweepShader,
    );
    ...
    canvas.drawCircle(wheel, 5, paintBlack);
    canvas.drawCircle(wheel, 5, paintWhite);
    ...
    canvas.drawCircle(paletteVector, 8, paintBlack);
    canvas.drawCircle(paletteVector, 8, paintWhite);
  }
